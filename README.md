...
Research, field notes & case files → **[adarshsarda.github.io](https://adarshsarda.github.io)** *(EN / DE)*
...
Qwen2.5-3B + LoRA · pre-registered thresholds · template-shortcut diagnosis · leakage-free rescore.

> **What this does not show.** ODSB is an M.Sc. course project — **not peer-reviewed**. Single-turn keyword filters have no obvious signal against it; **trajectory-level semantic defences were not evaluated**.

**[→ Code, data & evaluation](https://github.com/adarshsarda/Order-Dependent-Semantic-Backdoors)** · [full case file, CIs & limitations](https://adarshsarda.github.io/projects/odsb-semantic-backdoors/)

### `P-01` — Multimodal Emotion Recognition

LSTM over speech + text, ~86% accuracy. Co-author — Springer book chapter, *Frontiers of ICT in Healthcare*, LNNS 519 (2023).
...
- **16 paper explainers** — backdoors, prompt injection, RAG security, agent exploitation *(EN / DE)*.
- Presented *Where the Devil Hides* (CVPR 2025) — passcode-controlled training-data backdoors in deepfake detectors.

---

## 04 · Open inquiries

- **Deepfake detector robustness** — how far does a *frozen* FF++-trained detector's video-level performance fall under transfer to Celeb-DF v2 and a controlled JPEG / resize / blur grid?
...
[Portfolio & field notes](https://adarshsarda.github.io) · [LinkedIn](https://www.linkedin.com/in/adarshsarda) · [adarshsarda29@gmail.com](mailto:adarshsarda29@gmail.com)
